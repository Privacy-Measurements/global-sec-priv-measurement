...
class PageGraph:
    ...
    def cookie_nodes(self) -> list[CookieJarNode]:
        node_iterator = self.nodes_of_type(Node.Types.COOKIE_JAR)
        return cast(list["CookieJarNode"], node_iterator)

    def local_storage_nodes(self) -> list[LocalStorageNode]:
        node_iterator = self.nodes_of_type(Node.Types.LOCAL_STORAGE)
        return cast(list["LocalStorageNode"], node_iterator)

    def session_storage_nodes(self) -> list[SessionStorageNode]:
        node_iterator = self.nodes_of_type(Node.Types.SESSION_STORAGE)
        return cast(list["SessionStorageNode"], node_iterator)
